package com.roma.hrms.notification;
...
import com.roma.hrms.MainActivity;
import com.roma.hrms.R;

public class MyFirebaseMessagingService extends FirebaseMessagingService {
    private static final String TAG = "MyFirebaseMsgService";
    public static String Judul_Notifikasi;
    ...
    // Percobaan untuk notifikasi nampil ketika aplikasi di buka
    @Override
    ...
    private void sendNotification(String messageBody) {
        String Title = MyFirebaseMessagingService.Judul_Notifikasi;
