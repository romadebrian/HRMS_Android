package com.roma.hrms.network.config;

public class Config {

    public static final String BASE_URL = "https://roma3.000webhostapp.com"; // Your Local IP Address or Localhost (http://10.0.2.2/)
